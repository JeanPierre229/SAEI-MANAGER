<?php 
    ...
    if(!empty($_POST) && isset($_POST)){
        ...
        $requete = $connect->prepare("INSERT INTO bootcamp(type, theme, dureeParcours, frequence, dureeSeance, nombreCoach, nombreIncube, nombreJours) VALUES(?, ?, ?, ?, ?, ?, ?, ?)");
...
<head>
    ...
    <title>BootCamp de Rentré | SAEI-MANAGER</title>
            ...
            <div class="page-container">
                ...
                <div class="main-content">
                    <div class="page-header">
                        <h2 class="header-title">BootCamp de Rentré</h2>
                        <div class="header-sub-title">
                            <nav class="breadcrumb breadcrumb-dash">
                                ...
                                <span class="breadcrumb-item active">BootCamp de Rentré</span>
                            </nav>
                        </div>
                    </div>
                    <div class="row">
