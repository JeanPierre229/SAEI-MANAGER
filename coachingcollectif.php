<?php 
    ...
    if(!empty($_POST) && isset($_POST)){
        ...
        $requete = $connect->prepare("INSERT INTO coachingcollectif(type, theme, dureeParcours, frequence, dureeSeance, nombreCoach, nombreIncube, nombreJours) VALUES(?, ?, ?, ?, ?, ?, ?, ?)");
...
<head>
    ...
    <title>Coaching Collectif | SAEI-MANAGER</title>
            ...
            <div class="page-container">
                ...
                <div class="main-content">
                    <div class="page-header">
                        <h2 class="header-title">Coaching Collectif</h2>
                        <div class="header-sub-title">
                            <nav class="breadcrumb breadcrumb-dash">
                                ...
                                <span class="breadcrumb-item active">Coaching Collectif</span>
                            </nav>
                        </div>
                    </div>
                    <div class="row">
