<?php 
    ...
    if(!empty($_POST) && isset($_POST)){
        ...
        $requete = $connect->prepare("INSERT INTO formation(type, theme, dureeParcours, frequence, dureeSeance, nombreCoach, nombreIncube, nombreJours) VALUES(?, ?, ?, ?, ?, ?, ?, ?)");
...
<head>
    ...
    <title>Formation | SAEI-MANAGER</title>
