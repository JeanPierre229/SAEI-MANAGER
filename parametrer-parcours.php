...
<head>
    ...
    <title>Paramétrer un Parcours | SAEI-MANAGER</title>
            ...
            <div class="page-container">
                ...
                <div class="main-content">
                    <div class="page-header">
                        <h2 class="header-title">Paramétrer le Parcours</h2>
                        <div class="header-sub-title">
                            <nav class="breadcrumb breadcrumb-dash">
                                ...
                                <span class="breadcrumb-item active">Paramétrer le Parcours</span>
                            </nav>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 mx-auto bg-white" style="padding: 30px;">
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        <th><a href="parcours.php">Parcours</a></th>
                                        <th class="text-right px-5">Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php if($parcours['bootCamp'] == "bootcamp"): ?>
                                        <tr>
                                            <td>BootCamp de Rentré</td>
                                            <td class="text-right">
                                                <a href="bootcamp.php">
                                                    <button class="btn btn-green">Paramétrer</button>
                                                </a>
                                            </td>
                                        </tr>
                                    <?php endif ?>
                                    <?php if($parcours['coachingIndividuel'] == "coachingindividuel"): ?>
                                        <tr>
                                            <td>Coaching Individuel</td>
                                            <td class="text-right">
                                                <a href="coachingIndividuel.php">
                                                    <button class="btn btn-green">Paramétrer</button>
                                                </a>
                                            </td>
                                        </tr>
                                    <?php endif ?>
                                    <?php if($parcours['coachingCollectif'] == "coachingcollectif"): ?>
                                        <tr>
                                            <td>Coaching Collectif</td>
                                            <td class="text-right">
                                                <a href="coachingCollectif.php">
                                                    <button class="btn btn-green">Paramétrer</button>
                                                </a>
                                            </td>
                                        </tr>
                                    <?php endif ?>
                                    <?php if($parcours['formation'] == "formation"): ?>
                                        <tr>
                                            <td>Formation</td>
                                            <td class="text-right">
                                    ...
                                    <?php endif ?>
                                    <?php if($parcours['ceremonieFin'] == "ceremoniefin"): ?>
                                        <tr>
                                            <td>Cérémonie de fin</td>
                                            <td class="text-right">
                                                <a href="ceremoniefin.php">
                                                    <button class="btn btn-green">Paramétrer</button>
                                                </a>
                                            </td>
                                        </tr>
                                    <?php endif ?>
                                    <?php if($parcours['mentorat'] == "mentorat"): ?>
                                        <tr>
                                            <td>Mentorat</td>
                                            <td class="text-right">
                                                <a href="mentorat.php">
                                    ...
                                    <?php endif ?>
                                    <?php if($parcours['demoday'] == "demoday"): ?>
                                        <tr>
                                            <td>Demo Day</td>
                                            <td class="text-right">
                                                <a href="demoday.php">
